...
// filtering all the data from the API
    ...
    const alternateAvatars = user?.about?.alternateAvatars;
    const alternateAvatarUrl = alternateAvatars && alternateAvatars.length > 0 ? alternateAvatars[0].url : null;
    ...
    return (
        <>
            <Header />
            <Hero user = {user} alternateAvatarUrl={alternateAvatarUrl}/>
            <About user = {user}/>
            <Skills skills = {sortedFilteredSkills} />
            <Projects projects = {sortedFilteredProject} alternateAvatarUrl={alternateAvatarUrl}/>
            <Services services = {filteredServices}/>
            <Timeline education = {filteredEducation} experience = {filteredExperience}/>
            <Testimonial info = {filteredTestimonials}/>
            <Contact />
        </>
    );
}
